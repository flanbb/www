 window.onload = function() {
    var container = document.getElementById('map01');
    var options = {
        center: new daum.maps.LatLng(37.36502725804379, 126.72519701377668),
        level: 6
    };
    ...
    var markerPosition  = new daum.maps.LatLng(37.36502725804379, 126.72519701377668); 
    ...
    //두번째 맵
      ...
      var container2 = document.getElementById('map02');
    var options2 = {
        center: new daum.maps.LatLng(34.86794814733042, 128.69628494188424),
        level: 6
    };
    ...
    var markerPosition2  = new daum.maps.LatLng(34.86794814733042, 128.69628494188424); 
