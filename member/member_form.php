...
<body>
	...
	<article id="content">  
	  ...
	  <form  name="member_form" method="post" action="insert.php" class="window"> 
		<h2>회원가입</h2>
     <table>
 ...
 ?>        
  ...
  ?>			     
     	...
     	<tr>
     		<th scope="col"><label for="nick">별명</label></th>
     		<td>
     	...
     	<tr>
     		<td colspan="2">
     			<a id="button_ok" href="#"  onclick="check_input()">가입하기</a>
				<a id="button_cancel" href="#" onclick="reset_form()">지우기</a>
                <a id="button_index" href="../index.html">돌아가기</a>
     		</td>
     	</tr>
     </table>
